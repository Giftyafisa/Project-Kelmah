...
const ErrorFallback = ({ error }) => (
  <div style={{ padding: 24, backgroundColor: '#1A1A1A', color: '#FFD700', minHeight: '100vh' }}>
    <h2 style={{ color: '#FFD700', marginBottom: 16 }}>Something went wrong.</h2>
    <pre style={{ color: '#FF5252', whiteSpace: 'pre-wrap' }}>{error.message}</pre>
  </div>
);
