    ...
    return (
                ...
                <Grid item xs={12} md={isMobile ? 12 : 9}>
                    ...
                    {loading ? (
                        ...
                        <>
                                ...
                                <FormControl size="small" sx={{ minWidth: 160 }}>
                                    ...
                                    <Select
                                        ...
                                        sx={{
                                            ...
                                            '&:hover .MuiOutlinedInput-notchedOutline': { borderColor: theme.palette.secondary.dark },
                            ...
                            {jobs.map((job) => (
                                <JobCard key={job.id} job={job} onViewDetails={(id) => navigate(`/jobs/${id}`)} />
                            ))}
                        </>
                    )}
                    {/* Pagination Controls */}
        ...
        >
            <Box sx={{ width: 260, p: 2 }}>
                <Paper sx={{ p: 2, backgroundColor: theme.palette.primary.main, color: '#fff' }}>
