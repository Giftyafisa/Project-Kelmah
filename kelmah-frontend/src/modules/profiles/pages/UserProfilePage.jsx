                    ...
                    <Paper sx={{ p: 3 }}>
                        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <Box sx={{ width: '100%', mt: 2 }}>
                                ...
                                {user.location && (
                                    <Box sx={{ width: '100%', height: 200, borderRadius: 2, overflow: 'hidden', mt: 2 }}>
                                        <iframe
                                            title="User Location"
                            ...
                            {activeTab === 'reviews' && (
                                <Box>
                                    {reviews.length > 0 ? (
                                        <List>
                                            {reviews.map((rev) => (
                                                <ListItem key={rev.id || rev._id} alignItems="flex-start">
                                                        <ListItemAvatar>
                                            ...
                                            {user.portfolio.map((item, idx) => (
                                                <Grid item xs={12} sm={6} md={4} key={idx}>
                                                    <Paper elevation={3} sx={{ overflow: 'hidden' }}>
                                                        <img src={item.url} alt={item.title || 'Portfolio Item'} style={{ width: '100%', display: 'block' }} />
                                                    </Paper>
                                                </Grid>
                                            ))}
                                        </Grid>
